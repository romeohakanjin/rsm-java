		...
		case REFUSE_COMMENT:
			if (commentId != null || !commentId.equals("")) {
				...
				if (commentToRefuse != null) {
					...
					if (isRefuse) {
						getAllComment();
						setVariableToView("alert-success", "Commentaire supprim�");
						redirectionToView(COMMENT_MANAGEMENT);
					} else {
						setVariableToView("alert-danger", "La suppression de ce commentaire n'a pas pu �tre effectu�e");
					}
				}
			}
			break;
		case VALIDATE_COMMENT:
			if (commentId != null || !commentId.equals("")) {
				...
				if (commentToValidate != null) {
					...
					if (isValidate) {
						getAllComment();
						setVariableToView("alert-success", "Commentaire valid�");
						redirectionToView(COMMENT_MANAGEMENT);
					} else {
						setVariableToView("alert-warning", "La validation de ce commentaire n'a pas pu �tre effectu�e");
					}
				}
			}
			break;
